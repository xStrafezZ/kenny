...
let bbb = message.author
 ...
 if(blacklist.tiene(`${bbb.id}`)) return message.channel.send(embed0)
    ...
    let bodyURL = `https://minotar.net/armor/body/${text}/100.png`;
      ...
      .setDescription('Cuerpo de: `' + text + '`')
      .setThumbnail(`https://cdn.discordapp.com/emojis/682318852931322026.gif?v=1`)
      .setImage(bodyURL)
      .setTimestamp()
      .setColor(0x40FF00)
      .setFooter(message.author.tag, message.author.avatarURL)
message.channel.send(embed)//('Skin Del Usuario `'+ text+'`:',{ files: [skinURL] });
